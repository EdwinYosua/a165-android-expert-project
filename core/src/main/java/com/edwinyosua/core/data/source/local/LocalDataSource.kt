package com.edwinyosua.core.data.source.local

import com.edwinyosua.core.data.source.local.entity.TourismEntity
import com.edwinyosua.core.data.source.local.room.TourismDao
